...
NSString *ZZFilterDebugLogPath(void) {
    ...
    dispatch_once(&onceToken, ^{
        NSString *primary = @"/var/mobile/ZZFilterPlugin-v52.log";
        ...
        else path = @"/tmp/ZZFilterPlugin-v52.log";
...
#endif
    ZZFilterDebugWrite(@"[ZZDebug] v52 loaded arch=%s iOS-min=16.0 log=%@", arch, ZZFilterDebugLogPath());
}
