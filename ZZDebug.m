...
NSString *ZZFilterDebugLogPath(void) {
    ...
    dispatch_once(&onceToken, ^{
        NSString *primary = @"/var/mobile/ZZFilterPlugin-v26.log";
        ...
        else path = @"/tmp/ZZFilterPlugin-v26.log";
...
#endif
    ZZFilterDebugWrite(@"[ZZDebug] v26 loaded arch=%s iOS-min=16.0 log=%@", arch, ZZFilterDebugLogPath());
}
