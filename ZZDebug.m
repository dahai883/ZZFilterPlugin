...
NSString *ZZFilterDebugLogPath(void) {
    ...
    dispatch_once(&onceToken, ^{
        NSString *primary = @"/var/mobile/ZZFilterPlugin-v32.log";
        ...
        else path = @"/tmp/ZZFilterPlugin-v32.log";
...
#endif
    ZZFilterDebugWrite(@"[ZZDebug] v32 loaded arch=%s iOS-min=16.0 log=%@", arch, ZZFilterDebugLogPath());
}
