...
NSString *ZZFilterDebugLogPath(void) {
    ...
    dispatch_once(&onceToken, ^{
        NSString *primary = @"/var/mobile/ZZFilterPlugin-v27.log";
        ...
        else path = @"/tmp/ZZFilterPlugin-v27.log";
...
#endif
    ZZFilterDebugWrite(@"[ZZDebug] v27 loaded arch=%s iOS-min=16.0 log=%@", arch, ZZFilterDebugLogPath());
}
