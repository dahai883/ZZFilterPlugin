...
NSString *ZZFilterDebugLogPath(void) {
    ...
    dispatch_once(&onceToken, ^{
        NSString *primary = @"/var/mobile/ZZFilterPlugin-v58.log";
        ...
        else path = @"/tmp/ZZFilterPlugin-v58.log";
...
#endif
    ZZFilterDebugWrite(@"[ZZDebug] v58 loaded arch=%s iOS-min=16.0 log=%@", arch, ZZFilterDebugLogPath());
}
