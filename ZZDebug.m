...
NSString *ZZFilterDebugLogPath(void) {
    ...
    dispatch_once(&onceToken, ^{
        NSString *primary = @"/var/mobile/ZZFilterPlugin-v37.log";
        ...
        else path = @"/tmp/ZZFilterPlugin-v37.log";
...
#endif
    ZZFilterDebugWrite(@"[ZZDebug] v37 loaded arch=%s iOS-min=16.0 log=%@", arch, ZZFilterDebugLogPath());
}
