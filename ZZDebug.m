...
NSString *ZZFilterDebugLogPath(void) {
    ...
    dispatch_once(&onceToken, ^{
        NSString *primary = @"/var/mobile/ZZFilterPlugin-v25.log";
        ...
        else path = @"/tmp/ZZFilterPlugin-v25.log";
...
#endif
    ZZFilterDebugWrite(@"[ZZDebug] v25 loaded arch=%s iOS-min=16.0 log=%@", arch, ZZFilterDebugLogPath());
}
