...
FOUNDATION_EXPORT NSString *ZZObservedDetailLastRequestURL(void);
FOUNDATION_EXPORT NSString *ZZObservedDetailLastRequestMethod(void);
FOUNDATION_EXPORT NSString *ZZObservedDetailLastRequestBody(void);
