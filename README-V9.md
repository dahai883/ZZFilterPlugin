...
v10 is a stability-first diagnostic build for authorized testing of the host app.
...
- Adds a jailbreak-friendly diagnostic log at `/var/mobile/ZZFilterPlugin-v10.log`, with `/tmp/ZZFilterPlugin-v10.log` as fallback.
...
After injection, reproduce one search and one filter action, then run:
    ...
    tail -n 200 /var/mobile/ZZFilterPlugin-v10.log

If that path does not exist, try:

    tail -n 200 /tmp/ZZFilterPlugin-v10.log
